                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" action="{{ $link }}" method="POST"
                            ...
                            <div class="col-md-6">
                                @if(isset($data))
                                    <?= set_input_form2('image', 'thumbnail', ucwords(lang('thumbnail', $translation)), $data, $errors, false); ?>
                                @else
                                    <?= set_input_form2('image', 'thumbnail', ucwords(lang('thumbnail', $translation)), $data, $errors, true); ?>
                                @endif
                            </div>

                            <div class="col-md-6">
                                @if(isset($data))
                                    <?= set_input_form2('image', 'banner', ucwords(lang('banner', $translation)), $data, $errors, false); ?>
                                @else
                                    <?= set_input_form2('image', 'banner', ucwords(lang('banner', $translation)), $data, $errors, true); ?>
                                @endif
                            </div>
                            ...
                            @php
                                ...
                                $config = new \stdClass();
                                $config->defined_data = \App\Services\Admin\CategoryService::getList();
                                $config->separator = ',';
                                echo set_input_form2('select2', 'category_id', ucwords(lang('categories', $translation)), $data, $errors, false, $config);
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    ...
                                    <a href="{{ route('admin.project.list') }}" class="btn btn-danger"><i
                                            class="fa fa-times"></i>&nbsp;
                                        @if (isset($data))
