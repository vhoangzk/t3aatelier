    ...
    <div class="">
        ...
        <div class="page-title">
            ...
            @if (isset($data))
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        @if (Helper::authorizing('Project', 'Restore')['status'] == 'true')
                            <a href="{{ route('admin.project.deleted') }}" class="btn btn-round btn-danger"
                               style="float: right; margin-bottom: 5px;" data-toggle="tooltip"
                               title="{{ ucwords(lang('view deleted items', $translation)) }}">
                                <i class="fa fa-trash"></i>
                            </a>
                        @endif
                        <a href="{{ route('admin.project.create') }}" class="btn btn-round btn-success"
                           style="float: right;">
            ...
            @else
                <div class="title_right">
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                        <a href="{{ route('admin.project.list') }}" class="btn btn-round btn-primary"
                           style="float: right;">
                    ...
                    <div class="x_content">
                        <div class="table-responsive">
                            <table id="datatables" class="table table-striped table-bordered" style="display:none">
                                <thead>
                                <tr>
                                    <th>{{ ucwords(lang('categories', $translation)) }}</th>
                                    <th>{{ ucwords(lang('name', $translation)) }}</th>
                                    <th>{{ ucwords(lang('thumbnail', $translation)) }}</th>
                                    <th>{{ ucwords(lang('banner', $translation)) }}</th>
