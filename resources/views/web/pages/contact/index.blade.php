                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-md-12 col-sm-12 moudle bottom-space-no" style="">
                                                ...
                                                <div class="module-map-canvas" data-add="Corlears Hook Park"
                                                     style="height: 400px;" data-l="40.7116965"
                                                     data-r="-73.97969720000003" data-zoom="17" data-pin="t"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 moudle  bottom-space-no" style="">
                                            ...
                                            <div class="contactform ux-mod-nobg">
                                                ...
                                                <form action="contact.php" id="contact-form" class="contact_form"
                                                      method="POST">
                                                    <p class="span6"><input type="text" id="idi_name" name="idi_name"
                                                                            class="requiredField" value="Name"
                                                                            onBlur="if (this.value =='' ) {this.value = 'Name';}"
                                                                            onFocus="if (this.value == 'Name' || this.value == 'Required' ) { this.value = ''; }"/>
                                                    </p>
                                                    <p class="span6"><input type="text" id="idi_mail" name="idi_mail"
